    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, userRepository_1.default.findUserByEmailAndPassword(email, password)];
            case 1:
                user = _b.sent();
                if (user) {
                    jsonwebtoken_1.default.sign({ email: email }, 'super-key-super-secret', function (err, token) {
                        res.status(200).json({ token: token, message: 'User found correctly' });
                    });
                }
                else {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                user = _a.sent();
                if (user) {
                    res.status(200).json({ userRegistered: user, message: "User created correctlvby" });
                }
                else {
...
exports.userController.delete('/:id', checkToken, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                return [4 /*yield*/, userRepository_1.default.deleteById(id)];
            case 1:
                user = _a.sent();
                if (user) {
...
exports.userController.patch('/:id', checkToken, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                return [4 /*yield*/, userRepository_1.default.updateUser(id, req.body)];
            case 1:
                user = _a.sent();
                if (user) {
